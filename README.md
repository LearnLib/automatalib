...
[![Maven Central](https://maven-badges.sml.io/sonatype-central/net.automatalib/automata-parent/badge.svg?subject=maven%20central)](https://maven-badges.sml.io/sonatype-central/net.automatalib/automata-parent)
...
* model verification (LTL checking (via [LTSmin][ltsmin]), CTL & µ-calculus checking (via [M3C][m3c] + [ADD-Lib][addlib]))
