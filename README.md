...
Currently, it covers generic transition systems, Deterministic Finite Automata (DFAs) and Mealy machines as well as more advanced structures such as Visibly Pushdown Automata (VPDAs) or Subsequential Transducers (SSTs).
