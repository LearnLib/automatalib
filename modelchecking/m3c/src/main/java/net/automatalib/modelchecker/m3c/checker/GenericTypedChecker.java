...
class GenericTypedChecker<L, AP> extends InternalChecker<L, AP>
        implements ModelChecker<L, ContextFreeModalProcessSystem<L, AP>, FormulaNode<L, AP>, WitnessTree<L, AP>> {

    GenericTypedChecker(Function<? super ContextFreeModalProcessSystem<L, AP>, ? extends AbstractDDSolver<?, L, AP>> creator) {
        super(creator);
    }
    ...
    public @Nullable WitnessTree<L, AP> findCounterExample(ContextFreeModalProcessSystem<L, AP> cfmps,
        ...
        return doFindCounterExample(cfmps, property);
    }
}
