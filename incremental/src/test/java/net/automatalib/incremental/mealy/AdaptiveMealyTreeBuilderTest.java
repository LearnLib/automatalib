...
public class AdaptiveMealyTreeBuilderTest {
    ...
    public void testConflict() {
        adaptiveMealy.insert(W_1, W_1_O);
        Assert.assertNull("Expected no conflict but triggered one.", adaptiveMealy.conflicts(W_1, W_1_O));
        Assert.assertNotNull("Expected conflict but found none.", adaptiveMealy.conflicts(W_1, W_3_O));
