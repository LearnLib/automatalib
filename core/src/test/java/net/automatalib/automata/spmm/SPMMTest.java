...
public class SPMMTest {
    ...
    public SPMMTest() {
        final SPAAlphabet<Character> inputAlphabet =
                new DefaultSPAAlphabet<>(Alphabets.characters('a', 'c'), Alphabets.fromArray('S', 'T'), 'R');
        final SPAOutputAlphabet<Character> outputAlphabet =
                new DefaultSPAOutputAlphabet<>(Alphabets.characters('x', 'z'), '✗');
    ...
    private static MealyMachine<?, Character, ?, Character> buildSProcedure(SPAAlphabet<Character> alphabet) {
    ...
    private static MealyMachine<?, Character, ?, Character> buildTProcedure(SPAAlphabet<Character> alphabet) {
