...
class ConcatIterator<T> extends AbstractTwoLevelIterator<Iterator<? extends T>, T, T> {
    ...
    @Override
    protected Iterator<T> l2Iterator(Iterator<? extends T> l1Object) {
        return (Iterator<T>) l1Object;
    }
