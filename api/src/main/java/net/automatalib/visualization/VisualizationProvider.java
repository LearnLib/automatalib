...
public interface VisualizationProvider {
     ...
     * {@link AutomataLibProperty#VISUALIZATION_PROVIDER} property to select the chosen visualization provider.
     *
     ...
     * {@link AutomataLibProperty#VISUALIZATION_PROVIDER} property, the provider with the highest priority is chosen.
     *
