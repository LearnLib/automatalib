...
/**
 * Graph representation of an {@link SPMM} that displays all states of its sub-procedures once, i.e. without
...
public class SPMMGraphView<S, I> implements Graph<Pair<I, S>, Triple<I, I, S>> {
    ...
    public Collection<Pair<I, S>> getNodes() {
        ...
        for (final Map.Entry<I, MealyMachine<S, I, ?, ?>> e : subModels.entrySet()) {
    ...
    public Collection<Triple<I, I, S>> getOutgoingEdges(Pair<I, S> node) {
        ...
        final @NonNull MealyMachine<S, I, ?, ?> subModel = subModels.get(procedure);
    ...
    public VisualizationHelper<Pair<I, S>, Triple<I, I, S>> getVisualizationHelper() {
        return new SPMMVisualizationHelper<>(callAlphabet, subModels);
    }
