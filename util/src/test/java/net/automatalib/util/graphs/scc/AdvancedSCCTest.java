...
public class AdvancedSCCTest {

  @Test
  public void testFirstExampleSCC() {
    ...
    Set<Set<Integer>> expectedSCCs = Sets.newHashSet(
            Sets.newHashSet(n0),
            Sets.newHashSet(n1, n2, n3),
            Sets.newHashSet(n4)
    );
  ...
  * https://cs.nyu.edu/courses/spring17/CSCI-UA.0310-001/graphs-scc.pdf
   */
  @Test
  public void testSecondExampleSCC() {
    CompactSimpleGraph<Void> graph = new CompactSimpleGraph<>();
  ...
  * http://www.cse.cuhk.edu.hk/~taoyf/course/comp3506/lec/scc.pdf
   */
  @Test
  public void testThirdExampleSCC() {
    CompactSimpleGraph<Void> graph = new CompactSimpleGraph<>();
  ...
  * SIAM journal on computing, 1972, 1. Jg., Nr. 2, S. 146-160.
  ...
  public void testTarjansSCCPaperExample() {
    ...
    Set<Set<Integer>> expectedSCCs = Sets.newHashSet(
            Sets.newHashSet(n1, n2, n8),
            Sets.newHashSet(n6),
            Sets.newHashSet(n3, n4, n5, n7)
    );
