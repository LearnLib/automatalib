...
public class ADSKrichenTest extends AbstractADSTest {
    ...
    static {
        M3 = AutomatonBuilders.forMealy(new CompactMealy<Character, Integer>(Alphabets.characters('a', 'b')))
                              .withInitial("s1")
                              .from("s1")
                              .on('a')
                              .withOutput(0)
        ...
        M4 = AutomatonBuilders.forMealy(new CompactMealy<Character, Integer>(Alphabets.characters('a', 'b')))
                              .withInitial("s1")
                              .from("s1")
                              .on('a')
                              .withOutput(0)
        ...
        M5 = AutomatonBuilders.forMealy(new CompactMealy<Character, Integer>(Alphabets.characters('a', 'b')))
                              .withInitial("s1")
                              .from("s1")
                              .on('a')
                              .withOutput(0)
        ...
        M6 = AutomatonBuilders.forMealy(new CompactMealy<Character, Integer>(Alphabets.characters('a', 'b')))
                              .withInitial("s1")
                              .from("s1")
                              .on('a')
                              .withOutput(0)
