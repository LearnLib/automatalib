...
public class StateEquivalence {
	 ...
	 * {@link Automata#findSeparatingWord(UniversalDeterministicAutomaton, UniversalDeterministicAutomaton, Collection)}.
	 *
	 ...
	 * otherwise.
	 * @throws IllegalArgumentException if passed anything other than two states.
	 */
