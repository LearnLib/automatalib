...
final class Covers {
    ...
    public static <S, I, T> boolean incrementalStateCover(DeterministicAutomaton<S, I, T> automaton,
                                                          Collection<? extends I> inputs,
    ...
    public static <S, I, T> boolean incrementalCover(DeterministicAutomaton<S, I, T> automaton,
                                                     Collection<? extends I> inputs,
        ...
        Word<I>[] oldTransCoverArray =
                (oldTransCover.isEmpty()) ? null : oldTransCover.toArray(new Word[oldTransCover.size()]);
