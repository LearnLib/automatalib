...
public class OneSEVPAs {
	 ...
	 * SEVPAs.
	 *
	 * @param sevpa1   the first SEVPA
	 * @param sevpa2   the second SEVPA
	...
	/**
	 * Minimizes the given SEVPA over the given alphabet. This method does not modify the
	 * given SEVPA, but returns the minimized version as a new instance.
	 * <b>Note:</b> the SEVPA must be completely specified.
	 *
	 * @param sevpa    the SEVPA to be minimized
