 ...
 * the {@code with...} methods in a fluent interface-like manner.
 * <p>
 ...
 * {@link RandomAutomata}, such as
 * {@link RandomAutomata#randomICDFA(Random, int, Alphabet, boolean)}.
 * 
...
public class RandomICAutomatonGenerator<SP,TP> {
	...
	/**
	 * Creates a random IC automaton generator instance for generating DFAs. States in generated
	 * automata will be accepting or rejecting with equal probability.
	...
	/**
	 * Creates a random IC automaton generator instance for generating DFAs. The {@code acceptingRatio}
	 * parameter controls the probability of a state in a generated automaton being an accepting state.
	 * @param acceptingRatio the (approximate) ratio of accepting states in generated automata
	 * @return a random IC automaton generator instance for generating DFAs
	 */
	 ...
	 * <p>
	 * Using this function is discouraged, as it ignores the {@link Random} instance passed to the generation
	 * functions. If possible, use {@link #withStateProperties(Function)}.
	 * @param spSupplier the supplier for state properties
	 * @return {@code this}
	 */
	 ...
	 * 
	 * @param spFunc the function that supplies state properties, using a {@link Random} object as a source
	 * for randomness
	 * @return {@code this}
	 */
	...
	/**
	 * Sets the possible state properties, and returns {@code this}. The collection is internally converted into
	 * a list, from which state properties are selected using {@link RandomUtil#choose(List, Random)}. If the
	 * collection is empty, {@code null} will always be chosen as the state property.
	 * <p>
	 * Note that if the collection contains elements several times, the probability of these elements being selected
	 * is proportionally higher.
	 * 
	 * @param possibleSps the collection of possible state properties
	 * @return {@code this}
	 */
	...
	/**
	 * Sets the possible state properties, and returns {@code this}. State properties are selected from this
	 * array using {@link RandomUtil#choose(Object[], Random)}. If the array is empty, {@code null} will always
	 * be chosen as the state property.
	 * 
	 * @param possibleSps the possible state properties
	 * @return {@code this}
	 */
	@SafeVarargs
	 ...
	 * <p>
	 * Using this function is discouraged, as it ignores the {@link Random} instance passed to the generation
	 * functions. If possible, use {@link #withTransitionProperties(Function)}.
	 * @param tpSupplier the supplier for transition properties
	 * @return {@code this}
	 */
	 ...
	 * 
	 * @param tpFunc the function that supplies transition properties, using a {@link Random} object as a source
	 * for randomness
	 * @return {@code this}
	 */
	...
	/**
	 * Sets the possible transition properties, and returns {@code this}. The collection is internally converted into
	 * a list, from which transition properties are selected using {@link RandomUtil#choose(List, Random)}. If the
	 * collection is empty, {@code null} will always be chosen as the transition property.
	 * <p>
	 * Note that if the collection contains elements several times, the probability of these elements being selected
	 * is proportionally higher.
	 * 
	 * @param possibleTps the collection of possible transition properties
	 * @return {@code this}
	 */
	 ...
	 * be chosen as the state property.
	 * 
	 * @param possibleTps the possible transition properties
	 * @return {@code this}
	 */
	@SafeVarargs
	 ...
	 */
	public <I,A extends MutableDeterministic<?, I, ?, ? super SP, ? super TP>>
	A generateICDeterministicAutomaton(
			int numStates,
	 ...
	 * The resulting automaton is instantiated using the given {@code creator}. Note that the
	 * resulting automaton will <b>not</b> be minimized.
	 * 
	 * @param numStates the number of states of the resulting automaton
	 * @param alphabet the input alphabet of the resulting automaton
	 * @param creator an {@link AutomatonCreator} for instantiating the result automaton
	 * @param r the randomness source
