...
/**
 * An data class for aggregating access, terminating, and return sequences of an {@link SBA}.
 * <p>
 * An access sequence of a procedure is an input word that guarantees to transition the {@link SBA} from its initial
