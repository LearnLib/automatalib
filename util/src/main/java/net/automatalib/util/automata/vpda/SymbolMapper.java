...
public interface SymbolMapper<AI, CI> {
    ...
    /**
     * Returns for an abstract call symbol of a {@link VPDAlphabet} its mapped call symbol of a
    ...
    /**
     * Returns for an abstract internal symbol of a {@link VPDAlphabet} its mapped internal symbol of a
     * {@link ProceduralInputAlphabet}.
     * <p>
    ...
    /**
     * Returns for an abstract return symbol of a {@link VPDAlphabet} its mapped return symbol of a
     * {@link ProceduralInputAlphabet}.
     * <p>
     * Note that this is a stateless operation, i.e., multiple calls to this method with the same argument should return
     * the same results.
