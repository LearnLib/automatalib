...
public final class SPMMUtil {
    ...
    private static <S, I, O> Collection<I> discoverAccessSequences(ProceduralInputAlphabet<I> inputAlphabet,
    ...
    public static <I, O> @Nullable Word<I> findSeparatingWord(SPMM<?, I, ?, O> spmm1,
        ...
        for (final I procedure : alphabet.getCallAlphabet()) {
            final MealyMachine<?, I, ?, O> p1 = spmm1.getProcedure(procedure);
            final MealyMachine<?, I, ?, O> p2 = spmm2.getProcedure(procedure);
