...
public class LocalTimerMealyCover {
    ...
    public static <S, I, O> Map<S, Word<LocalTimerMealySemanticInputSymbol<I>>> getLocalTimerMealyLocationCover(LocalTimerMealy<S, I, O> automaton, Collection<LocalTimerMealySemanticInputSymbol<I>> inputs) {
        return getLocalTimerMealyLocationCover(automaton, inputs, true);
    }
     ...
     */
    public static <S, I, O> Map<S, Word<LocalTimerMealySemanticInputSymbol<I>>> getLocalTimerMealyLocationCover(LocalTimerMealy<S, I, O> automaton, Collection<LocalTimerMealySemanticInputSymbol<I>> inputs, boolean allowIncomplete) {
