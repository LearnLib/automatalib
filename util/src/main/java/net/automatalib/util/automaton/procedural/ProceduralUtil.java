...
final class ProceduralUtil {
    ...
    static <I, M extends FiniteSemantics<?, I, ?, ?, ?>> Map<I, Word<I>> computeTerminatingSequences(Map<I, ? extends M> procedures,
    ...
    static <I, M extends FiniteSemantics<?, I, ?, ?, ?>> Map<I, Word<I>> computeAccessSequences(Map<I, ? extends M> procedures,
                                                                                                ProceduralInputAlphabet<I> alphabet,
    ...
    private static <I, M extends FiniteSemantics<?, I, ?, ?, ?>> Collection<I> discoverAccessSequences(
            ProceduralInputAlphabet<I> alphabet,
            Collection<I> proceduralInputs,
            I procedure,
            M p,
    ...
    static <I, M extends FiniteSemantics<?, I, ?, ?, ?>> @Nullable Word<I> findSeparatingWord(Map<I, M> sys1,
                                                                                              ATSequences<I> at1,
                                                                                              Map<I, M> sys2,
                                                                                              ATSequences<I> at2,
                                                                                              ProceduralInputAlphabet<I> alphabet) {
