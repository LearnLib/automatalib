 ...
 * <p>
 * See <a href="https://doi.org/10.1109/TSE.1978.231496">Testing software design modeled by finite-state machines</a> by
 * Tsun S. Chow.
 *
 * @param <I>
 *         input symbol type
...
public class WMethodTestsIterator<I> extends AbstractThreeLevelIterator<Word<I>, List<I>, Word<I>, Word<I>> {
    ...
    /**
     * Convenience-constructor for {@link #WMethodTestsIterator(RegularAutomaton, Collection, int)} that selects
     ...
     */
    public WMethodTestsIterator(RegularAutomaton<?, I, ?, ?, ?> automaton, Collection<? extends I> inputs) {
     ...
     */
    public WMethodTestsIterator(RegularAutomaton<?, I, ?, ?, ?> automaton,
