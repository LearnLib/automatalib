...
public final class GraphDOT {
    ...
    public static <N, E> void writeRaw(Graph<N, E> graph,
                                       ...
                                       Appendable a,
                                       GraphDOTHelper<N, ? super E>... additionalHelpers) throws IOException {
    ...
    public static <N, E> void writeRaw(Graph<N, E> graph, Appendable a, List<GraphDOTHelper<N, ? super E>> helpers)
            throws IOException {
     ...
     *         if writing to <tt>a</tt> fails
     */
    public static <N, E> void writeRaw(Graph<N, E> graph, GraphDOTHelper<N, ? super E> dotHelperOrNull, Appendable a)
            throws IOException {

        final GraphDOTHelper<N, ? super E> dotHelper;
    ...
    private static void appendParams(Map<String, String> params, Appendable a) throws IOException {
        ...
        for (Map.Entry<String, String> e : params.entrySet()) {
            ...
            if (key.equals(GraphDOTHelper.CommonAttrs.LABEL) && value.toUpperCase().startsWith(htmlTag)) {
